...
struct FlashcardBrain {
    ...
    private var allFlashcards = [
        Flashcard(text: "but those who hope in the LORD will renew their strength. They will soar on wings like eagles; they will run and not grow weary, they will walk and not be faint.", source: "Isaiah 40:31"),
    ...
    mutating func addFlashcard(text: String, source: String ) {
        allFlashcardCount += 1
        let flashcard = Flashcard(text: text, source: source)
